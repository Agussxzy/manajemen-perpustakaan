...
if ($stok > 0) {
    ...
    // Simpan peminjaman 
    $query = "INSERT INTO peminjaman (id_buku, id_anggota, tanggal_pinjam, 
tanggal_jatuh_tempo, status)  
VALUES ($id_buku, $id_anggota, '$tanggal_pinjam', '$tanggal_jatuh_tempo', 
'dipinjam')";
    ...
    header("Location: ../index.php?page=peminjaman&status=stok_habis");
}
